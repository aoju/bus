    ...
    <div id="container">
         ...
         <h3><spring:message code="org.ukettle.Kettle.JobTrans.Info" /></h3>
     	 ...
     	 <div class="left">
             ...
             <p><label><spring:message code="org.ukettle.Kettle.JobTrans.Remark" /></label><textarea rows="1" cols="1" name="remark"></textarea></p>
             <div id="params">
             ...
             <input type="button" disabled id="iKettle" value="<spring:message code="org.ukettle.Kettle.JobTrans.submit" />" />
             </div>
