     	 ...
     	 <div class="left">
         	 ...
         	 <p><label><spring:message code="org.ukettle.User.Type" /></label>
         	  <select id="type" name="type">
				  <option value="Kettle"><spring:message code="org.ukettle.Type.Kettle" /></option>
				  <option value="Quartz"><spring:message code="org.ukettle.Type.Quartz" /></option>
			  </select>
         	 </p>
         	 <p><label><spring:message code="org.ukettle.User.Status" /></label>
         	  <select id="status" name="status">
				  <option value="ENABLED"><spring:message code="org.ukettle.Status.Enabled" /></option>
				  <option value="DISABLED"><spring:message code="org.ukettle.Status.Disabled" /></option>
			  </select>
         	 </p>
