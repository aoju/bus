 ...
 * @since JDK 1.8+
 */
public abstract class AbstractOfficePoolEntry implements OfficeManager {

    protected final OfficeManagerEntryConfig config;
     ...
     * @param config 输入配置.
     */
    public AbstractOfficePoolEntry(final OfficeManagerEntryConfig config) {
