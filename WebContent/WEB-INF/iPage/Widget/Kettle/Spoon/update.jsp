    ...
    <div id="container">
         ...
         <h3><spring:message code="com.ukettle.Kettle.JobTrans.Info" /></h3>
     	 ...
     	 <div class="left">
             ...
             <p><label><spring:message code="com.ukettle.Kettle.JobTrans.Remark" /></label>
             ...
             <div id="params">
         	 ...
         	 <input type="reset" onClick="window.history.go(-1);" value="<spring:message code="com.ukettle.Kettle.Running.Back" />" />
             <input type="button" id="iKettle" value="<spring:message code="com.ukettle.Kettle.JobTrans.submit" />" />
             </div>
