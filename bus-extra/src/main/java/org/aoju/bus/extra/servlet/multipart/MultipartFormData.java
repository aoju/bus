...
public class MultipartFormData {
    ...
    private void putFile(String name, UploadFile uploadFile) {
        ...
        fileUploads = fileUploads == null ? new UploadFile[]{uploadFile} : ArrayUtils.append(fileUploads, uploadFile);
    ...
    private void putParameter(String name, String value) {
        ...
        params = params == null ? new String[]{value} : ArrayUtils.append(params, value);
