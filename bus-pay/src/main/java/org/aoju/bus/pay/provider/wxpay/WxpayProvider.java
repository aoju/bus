...
import org.aoju.bus.pay.provider.wxpay.enums.WxApiType;
...
public class WxpayProvider {
     ...
     *
     * @param apiUrl 接口 URL
     *               通过 {@link WxpayProvider#getReqUrl(WxApiType)}
     *               或者 {@link WxpayProvider#getReqUrl(WxApiType, WxDomain, boolean)} 来获取
     * @param params 接口请求参数
