...
public class ThreeDesUtil {
    ...
    public static String decrypt4HexStr(byte[] keys, String data) {
        ...
        try {
            hexSourceData = hex2byte(data.getBytes(StandardCharsets.UTF_8));
    ...
    public static void main(String[] args) {
        ...
        System.out.println("加密前HEX:" + bytes2Hex(szSrc.getBytes(StandardCharsets.UTF_8)));
        encoded = encrypt(DEFAULT_KEY, szSrc.getBytes(StandardCharsets.UTF_8));
