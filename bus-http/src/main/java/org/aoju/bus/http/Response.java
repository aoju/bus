...
public final class Response implements Closeable {
     ...
     *
     * <p>If a challenge uses the {@code token68} variant instead of auth params, there is exactly first
     * auth param in the challenge at key {@code null}. Invalid headers and challenges are ignored.
     * No semantic validate is done, for example that {@code Basic} auth must have a {@code realm}
    ...
    /**
     * Returns a {@linkplain System#currentTimeMillis() timestamp} taken immediately before HttpClient
    ...
    /**
     * Returns a {@linkplain System#currentTimeMillis() timestamp} taken immediately after HttpClient
