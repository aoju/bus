...
<form action="<%=request.getContextPath()%>/Index" method="post">
    <p class="field">
        <label for="email"></label><input type="email" name="username" value="${username}" required placeholder="<spring:message code="com.ukettle.Shiro.Email" />">
        <i class="icon-user icon-large"></i>
    </p>
    <p class="field">
        <input type="password" name="password" required placeholder="<spring:message code="com.ukettle.Shiro.Pass" />">
