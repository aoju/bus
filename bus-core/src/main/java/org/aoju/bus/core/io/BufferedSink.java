...
public interface BufferedSink extends Sink, WritableByteChannel {
    ...
    /**
     * Writes all buffered data to the underlying sink, if first exists. Then that sink is recursively
     ...
     *   BufferedSink b1 = IoUtils.buffer(b0);
     *   BufferedSink b2 = IoUtils.buffer(b1);
     *
     *   b2.writeUtf8("hello");
    ...
    /**
     * Writes all buffered data to the underlying sink, if first exists. Like {@link #flush}, but
    ...
    /**
     * Writes complete segments to the underlying sink, if first exists. Like {@link #flush}, but
