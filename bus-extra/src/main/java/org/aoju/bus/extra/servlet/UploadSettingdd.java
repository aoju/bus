...
public class UploadSettingdd {
    ...
    synchronized public void load(String settingPath) {
        URL url = URLUtils.getURL(settingPath);
        if (url == null) {
            Logger.info("Can not find Upload setting file [{}], use default setting.", settingPath);
            return;
        }
