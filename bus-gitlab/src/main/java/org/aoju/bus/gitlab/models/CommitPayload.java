...
public class CommitPayload {
    ...
    private List<org.aoju.bus.gitlab.models.CommitAction> actions;
    ...
    public List<org.aoju.bus.gitlab.models.CommitAction> getActions() {
        return actions;
    }

    public void setActions(List<org.aoju.bus.gitlab.models.CommitAction> actions) {
        this.actions = actions;
    }

    public CommitPayload withActions(List<org.aoju.bus.gitlab.models.CommitAction> actions) {
        this.actions = actions;
        return (this);
    }

    public CommitPayload withAction(org.aoju.bus.gitlab.models.CommitAction action) {
    ...
    public CommitPayload withAction(org.aoju.bus.gitlab.models.CommitAction.Action action, String filePath) {
        return (withAction(action, null, filePath));
    }

    public CommitPayload withAction(org.aoju.bus.gitlab.models.CommitAction.Action action, String content, String filePath) {
        org.aoju.bus.gitlab.models.CommitAction commitAction = new CommitAction()
                .withAction(action)
                .withContent(content)
