...
public class TestController {
    ...
    @GetMapping("/c")
    @ClientVersion(expression = {"1>6.2.1"})
    public String cvcheck1(){return "6.2.1以上版本的1类型";}

    @GetMapping("/c")
    @ClientVersion({@TerminalVersion(terminals = 2,op= VersionOperator.GT,version = "6.2.1")})
    public String cvcheck2(){return "6.2.1以上版本的2类型";}

    @GetMapping("/c")
    @ClientVersion({@TerminalVersion(terminals = 2,op= VersionOperator.LTE,version = "6.2.1")})
    public String cvcheck3(){return "6.2.1以下版本的2类型";}
