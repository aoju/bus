...
public class XmlEncryptUtil {
    ...
    public static String encrypt(String rsaPrivateKey, String strDesKey, String genSignStr) {
        ...
        if (StringKit.isNotEmpty(rsaPrivateKey)
            ...
            try {
                ...
                encrypt = Base64.encode(ThreeDesUtil.encrypt2HexStr(RsaUtil.decryptBASE64(strDesKey), data).getBytes(StandardCharsets.UTF_8));
            } catch (Exception e) {
    ...
    public static String decrypt(String rsaPubKey, String strDesKey, String encrypt) {
        ...
        try {
            reqBody = ThreeDesUtil.decrypt4HexStr(RsaUtil.decryptBASE64(strDesKey), new String(Base64.decode(encrypt), StandardCharsets.UTF_8));
