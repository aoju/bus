     	 ...
     	 <div class="left">
			 ...
			 <c:choose>
               <c:when test="${empty Entity.repo}">
			  	   <p><label><spring:message code="org.ukettle.Quartz.Executor" /></label><input type="text" class="text-long" id="executor" name="executor" readOnly/>
			       <a href="javascript:void(0);" onclick="quartz.choose();"><i class="icon-zoom-in"></i></a>
			       </p>
			   </c:when>
			   <c:otherwise>  
			      <input type="hidden" id="executor" name="executor" value="org.ukettle.quartz.timer.kettle.KettleExecutor" readOnly/> 
			   </c:otherwise>
			 </c:choose>
             <div id="params">
         	 ...
         	 <p><label><spring:message code="org.ukettle.Quartz.Trigger" /></label>
				<input type="radio" id="triggerType" name="triggerType" value="simple" checked onclick="quartz.trigger();" /><spring:message code="org.ukettle.Quartz.Trigger.Simple" />&nbsp;&nbsp;
				<input type="radio"  id="triggerType" name="triggerType" value="cron" onclick="quartz.trigger();" /><spring:message code="org.ukettle.Quartz.Trigger.Cron" />
			 </p>
			 <div id="simpleTrigger">
         	     <p><label class="inline"><spring:message code="org.ukettle.Quartz.Trigger.Frequency" /></label><input type="number" required max="60" data-error-type="inline" style="padding-left: 66px;" id="frequency" name="frequency" class="text-long" value="5"/> <spring:message code="org.ukettle.Quartz.Trigger.Tips.Minute" /></p>
	         	 <p><label class="inline"><spring:message code="org.ukettle.Quartz.Trigger.Quantity" /></label><input type="number" required max="60" data-error-type="inline" style="padding-left: 66px;" id="quantity" name="quantity" class="text-long" value="-1" /> <spring:message code="org.ukettle.Quartz.Trigger.Tips.Continuous" /></p>
         	 </div>
			 <div id="cronTrigger" style="display: none;">
	         	 <p><label class="inline"><spring:message code="org.ukettle.Quartz.Trigger.Second" /></label><input type="text" data-error-type="inline" style="padding-left: 66px;" id="second" name="second" value="0" class="text-long"/></p>
	         	 <p><label class="inline"><spring:message code="org.ukettle.Quartz.Trigger.Minute" /></label><input type="text" data-error-type="inline" style="padding-left: 66px;" id="minute" name="minute" value="*" class="text-long"/></p>
	         	 <p><label class="inline"><spring:message code="org.ukettle.Quartz.Trigger.Hour" /></label><input type="text" data-error-type="inline" style="padding-left: 66px;" id="hour" name="hour" value="*" class="text-long"/></p>
	         	 <p><label class="inline"><spring:message code="org.ukettle.Quartz.Trigger.Day" /></label><input type="text" data-error-type="inline" style="padding-left: 66px;" id="day" name="day" value="*" class="text-long"/></p>
	         	 <p><label class="inline"><spring:message code="org.ukettle.Quartz.Trigger.Month" /></label><input type="text" data-error-type="inline" style="padding-left: 66px;" id="month" name="month" value="*" class="text-long"/></p>
	         	 <p><label class="inline"><spring:message code="org.ukettle.Quartz.Trigger.Week" /></label><input type="text" data-error-type="inline" style="padding-left: 66px;" id="week" name="week" value="?" class="text-long"/></p>
         	 </div>
             ...
             <input type="button" id="iQuartz" value="<spring:message code="org.ukettle.User.Submit" />" />
             </div>
