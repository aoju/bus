...
public class Constant extends Const {
	...
	static {
		...
		MAIL_USERNAME = props.getProperty("org.ukettle.mail.username");
		MAIL_PASSWORD = props.getProperty("org.ukettle.mail.password");
		MAIL_SMTP = props.getProperty("org.ukettle.mail.smtp");
		MAIL_PORT = props.getProperty("org.ukettle.mail.port");
		MAIL_SENDER = props.getProperty("org.ukettle.mail.sender");
		EXEC_PATH = props.getProperty("org.ukettle.quartz.exec");
		KETTLE_HOME = uKettle() + props.getProperty("org.ukettle.kettle.home");
		KETTLE_PLUGIN = KETTLE_HOME + FILE_SEPARATOR
				+ props.getProperty("org.ukettle.kettle.plugin");
		KETTLE_SCRIPT = uKettle()
				+ props.getProperty("org.ukettle.kettle.script");
		KETTLE_LOGLEVEL = logger(props
				.getProperty("org.ukettle.kettle.loglevel"));
